...
<h3>At Athena, we don’t want your design to just be good. We want to create a design that is memorable, defines your brand, and impresses the customer.</h3>
    ...
    <div className=' col-12 col-md-6  webdesignSection3img'>
        <img src='/images/laptop.png'></img>
    </div>
<div className=" col-12 col-md-6 webdesignSection3c2 ">
     
<h3>To do this, we combine aesthetics, functionality, and outstanding technology. By using color schemes, mood boards, and sample designs, we collaborate with you to develop a design that you confidently feel encompasses your ideas and creative vision and reflects your brand.</h3>
...
export default WebDesignSection3