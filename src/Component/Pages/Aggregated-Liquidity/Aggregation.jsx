        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-12 col-md-10">
                    ...
                    <img className="w-100 h-auto d-none d-lg-block" src="Assets/Images/18.png" alt="" />
                    <img className="w-100 h-auto d-block d-lg-none my-5" src="Assets/Images/aggregated-3-768x583.png" alt="" />
